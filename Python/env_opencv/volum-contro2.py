...
while True:
    ...
    if len(lmList)!= 0:
        ...
        # so gía trị length trong khoảng[25,250] ứng vs 1 giá trị vol trong khoảng [minVol,maxVol]
        ...
        volBar = np.interp(length, [25, 250], [400, 150]) # lây giá trị tọa độ y để vẽ lên màn hình volBar
